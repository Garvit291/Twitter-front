    ...
    <span
      className={
        classNames(
          ...
          status.startsWith("good")||status.startsWith("very good")  ? "bg-green-200 text-green-800" : null,
          status.startsWith("neutral") ? "bg-yellow-100 text-yellow-800" : null,
          status.startsWith("bad") || status.startsWith("very bad") ? "bg-red-100 text-red-800" : null,
        )
      }
    >
      {status}
  ...
  return (
    <span
      className={
        classNames(
          "px-3 py-1 uppercase leading-wide font-bold text-xs rounded-full shadow-sm",
          status.startsWith("positive")  ? "bg-green-200 text-green-800" : null,
          status.startsWith("neutral") ? "bg-yellow-100 text-yellow-800" : null,
          status.startsWith("negative")  ? "bg-red-100 text-red-800" : null,
        )
      }
    >
      {status}
    ...
    return (
        <div
          className=
              ...
              "px-3 py-1 text-xs w-60 line-clamp-3 "
